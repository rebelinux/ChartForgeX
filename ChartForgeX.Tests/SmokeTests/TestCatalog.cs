...
internal static partial class SmokeTests {
    internal static (string Name, Action Run)[] Tests { get; } = {
        ...
        ("Dotted map clamps polar points into visible map band", DottedMapClampsPolarPointsIntoVisibleMapBand),
        ("Dotted map data labels stay inside fitted map band", DottedMapDataLabelsStayInsideFittedMapBand),
        ...
        ("US state geographic map renders geographic choropleth regions", UsStateGeoMapRendersGeographicChoroplethRegions),
        ("US state tile map renders regional choropleth tiles", UsStateTileMapRendersRegionalChoroplethTiles),
        ("US state maps accept state names and DC aliases", UsStateMapsAcceptStateNamesAndDcAliases),
        ("US state tile map labels can be hidden for compact cards", UsStateTileMapLabelsCanBeHiddenForCompactCards),
        ("US state geographic map scale legend can be hidden for compact cards", UsStateGeoMapScaleLegendCanBeHiddenForCompactCards),
        ("US state geographic map labels only render when regions have room", UsStateGeoMapLabelsOnlyRenderWhenRegionsHaveRoom),
        ("US state tile map scale legend can be hidden for compact cards", UsStateTileMapScaleLegendCanBeHiddenForCompactCards),
        ("US state map scale legend separates no data from low values", UsStateMapScaleLegendSeparatesNoDataFromLowValues),
        ("US state map no-data scale stays inside compact cards", UsStateMapNoDataScaleStaysInsideCompactCards),
