...
internal static partial class SmokeTests {
    private static void ZeroValueSpecializedChartsPreservePointIndexes() {
        ...
        Assert(funnelSvg.Contains("data-cfx-role=\"funnel-segment\" data-cfx-point=\"1\" data-cfx-label=\"Qualify\" data-cfx-value=\"0\"", StringComparison.Ordinal), "Zero funnel stages should keep their original point metadata.");
        ...
        Assert(funnelSvg.Contains("data-cfx-role=\"funnel-segment\" data-cfx-point=\"2\" data-cfx-label=\"Close\" data-cfx-value=\"32\" data-cfx-retention=\"0.267\" data-cfx-dropoff=\"0\"", StringComparison.Ordinal), "Funnel stages after a zero previous stage should not report a fake drop-off from a zero baseline.");
