...
public static partial class GalleryWriter {
    ...
    public static void Write(string output) {
        ...
        sb.AppendLine("<nav><a href=\"" + CatalogFileName + "\">Grouped catalog</a><a href=\"topology-demo.html\">Topology demos</a><a href=\"" + QualityDashboardFileName + "\">Quality dashboard</a><a href=\"" + ComparisonFileName + "\">SVG/PNG comparison</a></nav>");
        sb.AppendLine("</header>");
        sb.AppendLine("<main>");
