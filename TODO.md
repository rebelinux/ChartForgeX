...
- Continue growing the dependency-free inline SVG raster layer for topology PNG artwork: radial gradients, clip paths, masks, richer text anchoring, and reusable diagnostics should be added through typed parser/renderer stages rather than ad hoc string handling.
